...
<div class="row">
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:834px;height:430px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:838px;height:430px;overflow:hidden;">
            <div>
                <img data-u="image" src="images/therapypage/slider/NSC.TL.Web.slider.CS.V5.jpg" />
            </div>
            <div>
                <img data-u="image" src="images/therapypage/slider/NSC.TL.Web.Carousel.PS.V5.jpg" />
            </div>
            <div>
                <img data-u="image" src="images/therapypage/slider/NSC.TL.Web.slider.PS.V4.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
...
<div class="row hidden-xs">
	<div id="tabs" class="tabs">
		...
		<div id="tabs-1">
			...
			<div class="row">
				...
				<div class="row">
					...
					<div class="row">				
						<div class="col-md-12">
							<p class="csDailyLipMaintenance">With the powerful active ingredient allantoin and patented Nerium oleander extract, this formula incorporates the sun protection ingredient ethylhexyl methocinnamate, to ensure that your lips are protected from all harmful environmental elements and stressors.</p>
						</div>
					</div>
			   <hr class="redHR" />
				</div>
			...
			<div class="row">
				<h1 class="lipTherapy">HOW TO USE</h1>
					...
					<div class="col-sm-3 visible-lg visible-md">
						<p class="csHowToUse"><span>Use Cold Sore Therapy:</span> Apply to cold sore 3 to 4 times daily. Recommended to clean hands prior to applying.</p>
					</div>
					<div class="col-sm-1 visible-lg visible-md">
					...
					<div class="col-sm-3 visible-lg visible-md">
						<p class="csHowToUse"><span>Use Daily Lip Maintenance:</span><br />Apply as needed for continuous lip health. Use only after cold sore is fully healed. Recommended to clean applicator in between use.</p>
					</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 hidden-lg hidden-md">
					<p class="csHowToUse"><span>Use Daily Lip Maintenance:</span> Apply as needed for continuous lip health. Use only after cold sore is fully healed. Recommended to clean applicator in between use.</p>
				</div>
				<div class="col-sm-2 hidden-lg hidden-md"></div>	
			</div>
			...
			<div class="row">
				...
				<ul class="csSymptomsList">
					<li><p>Tingling and itching</p><img src="images/therapypage/cold-sore-symptoms/NSC.TL.Website.Symptoms_CS.1.tingling.png" alt="symptom illustration" class="center-block"></img></li>
					<li><p>Blisters</p><img src="images/therapypage/cold-sore-symptoms/NSC.TL.Website.Symptoms_CS.2.blister.png" alt="symptom illustration" class="center-block"></img></li>
					<li><p>Oozing and crusting</p><img src="images/therapypage/cold-sore-symptoms/NSC.TL.Website.Symptoms_CS.3.crusting.png" alt="symptom illustration" class="center-block"></img></li>
				</ul>
			...
			<div class="row">
				...
				<img src="images/therapypage/Key.Ingredients.ColdSore.V6.png" alt="cold sore key ingredients" class="img-responsive center-block">
			</div>
		</div>
		...
		<div id="tabs-2">
			...
			<div class="row">
				<h1 class="lipTherapy">KEY INGREDIENTS</h1>
				<img src="images/therapypage/Key.Ingredients.Psoriasis.V4.png" alt="psoriasis ingredients" class="center-block img-responsive">		
			</div>
		</div>
		...
		<div id="tabs-3">
			...
			<div class="row=">
				<h1 class="lipTherapy">KEY INGREDIENTS</h1>
				<img src="images/therapypage/Key.Ingredients.Dermal.Pain.V4.png" alt="psoriasis ingredients" class="center-block img-responsive">
			</div>
		</div>
	</div>
</div>
